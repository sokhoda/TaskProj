...
<div class="container-fluid bg-grey">
 	   ...
 	   <h2><fmt:message key="utypefilter.header" bundle="${bndmmenu}"/>
 	   </h2>
  	   <div class="form-group ">
          <label for= "reg1" class="lb-lg"><fmt:message key="label.namepattern" bundle="${bndmmenu}"/></label>
         <input class="form-control input-lg" id="reg1" type="text" value="${utypenamepattern}" name="utypenamepattern">
       </div>

 <div class="text-center">
    <div class="btn-group"> 
	  <button type="button" class="btn1  btn-default btn-lg btn-info" onclick="setCommand3('ShUserTypeList');"> 
