...
<!-- 	mcagents, custagents, mgragents -->
	...
	<div class="container-fluid bg-grey">
		...
		<h2>
			...
			<fmt:message key="documentupdate.header" bundle="${bndmmenu}" />
		</h2>
...
<!-- status -->			
		 <div class="panel panel-primary">
	         <div class="panel-heading lb-lg"><fmt:message key="label.status" bundle="${bndmmenu}" /></div>
	          <div class="panel-body">
		          <div class="col-sm-6 col-md-5">
					<div class="form-group">
						<label for="mgr" class="lb-lg"><fmt:message key="label.status" bundle="${bndmmenu}" />
						</label> 
							<select size="1" class="form-control input-lg selectpicker status" id="status" name="status">
								<option disabled>select item</option>
							 <c:forEach var="ds" items="${docstatuses}" varStatus="cnt">
									<option value="${ds.id}"
									<c:if test="${ds.id == document.docStatus}"> selected </c:if>
		 ...
		 <div class="panel panel-success">
	         <div class="panel-heading lb-lg"><fmt:message key="label.loadinfo" bundle="${bndmmenu}" /></div>
	          <div class="panel-body">
				  ...
				  <div class="col-sm-6 col-md-3">
					<div class="form-group ">
						<label for="reg1" class="lb-lg"><span class="glyphicon glyphicon-time"></span>
...
<!-- Sum		-->
	...
	<div class="text-center">
		<div class="btn-group">
			...
			onclick="setCommand3('DocumentUpdate')"><fmt:message key="button.update" bundle="${bndmmenu}" />
			</button>
